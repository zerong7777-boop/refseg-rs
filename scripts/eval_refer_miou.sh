#!/usr/bin/env bash
# Purpose: evaluate the refer_data_20250908 mIoU-best packaged checkpoint.
# Expected env: set REFSEG_REFER_DATA_ROOT; optionally source examples/env.sh first.
# Output: ${REFSEG_REPORT_JSON:-${REFSEG_OUTPUT_ROOT}/eval_refer_miou/report_t03.json}.
# Metric target: mIoU-best checkpoint, evaluated at pred-threshold 0.3 by default.
set -euo pipefail
...
REPORT_JSON="${REFSEG_REPORT_JSON:-${OUTPUT_ROOT}/eval_refer_miou/report_t03.json}"
